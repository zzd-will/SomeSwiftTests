...
class MainViewController: CSPageViewController, CSPageViewControllerDataSource, CSPageViewControllerDelegate {
    ...
    override var tabbarPosition: CSTabbarPosition {
        get {
            if DeviceType.iPad {
                return .Right
            }
    ...
    override var tabbarStyle: CSTabbarStyle {
        get {
            if DeviceType.iPad {
                return .Solid
            }
    ...
    override var tabStyle: CSTabStyle {
        get {
    ...
    func tabViewForPageAtIndex(pageViewController: CSPageViewController, index: Int) -> UIView {
        let tabView: CSTabBarItem! = CSTabBarItem(frame: CGRectMake(0.0, 0.0, self.view.bounds.width / 6.0, 21.0), text: "已收货", image:nil, color: nil)
...
//            (tabView as! UILabel).text = "已收货"
//            tabView.textLabel?.text = "已收货"
            tabView.textLabel?.font = UIFont.systemFontOfSize(17)
            tabView.tintColor = UIColor.redColor()
            
//             (tabView as! UILabel).textColor = UIColor.blueColor()
...
//        }
    ...
    func widthForTabAtIndex(index: Int) -> CGFloat {
        if DeviceType.iPad {
            ...
            var tabSize = (String("已收货")).sizeWithAttributes([NSFontAttributeName: UIFont.systemFontOfSize(17)])
